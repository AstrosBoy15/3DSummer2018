...
public class ShadowBox {
	...
	protected void update() {
		...
		Vector4f tempRot = new Vector4f();
		rotation.transform(FORWARD, tempRot);
		Vector3f forwardVector = new Vector3f(tempRot.x, tempRot.y, tempRot.z);
	...
	protected Vector3f getCenter() {
		...
		cen = invertedLight.transform(cen);
	...
	private Vector4f[] calculateFrustumVertices(Matrix4f rotation, Vector3f forwardVector,
		...
		Vector4f tempRot = new Vector4f();
		rotation.transform(UP, tempRot);
		Vector3f upVector = new Vector3f(tempRot.x, tempRot.y, tempRot.z);
