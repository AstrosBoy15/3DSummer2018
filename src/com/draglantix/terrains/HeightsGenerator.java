package com.draglantix.terrains;
...
public class HeightsGenerator {
	...
	private int seed;
	private final int RAND_1 = rand.nextInt(300000);
	private final int RAND_2 = rand.nextInt(300000);
	...
	private float getNoise(int x, int z) {
		rand.setSeed(x * RAND_1 + z * RAND_2 + seed);
